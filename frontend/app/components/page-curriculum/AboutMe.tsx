...
const AboutMe = async () => {
  ...
  const responseAbutMe = await fetch(
    process.env.NEXT_PUBLIC_GET_ABOUT_ME_URL as string,
    {
      method: "GET",
    },
  );
  ...
  const responseValues = await fetch(
    process.env.NEXT_PUBLIC_GET_VALUES_URL as string,
    {
      method: "GET",
    },
  );

  const dataAboutMe = await responseAbutMe.json();
  const responseValue = await responseValues.json();
  ...
  const workValues = [
    ...
    {
      title: "Constancia",
      description: "Capacidad para abordar problemas complejos",
    },
    {
      title: "Evolucion continua",
      description: "Vanguardia tecnologica del dia a dia",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-gray-700">
          ...
          <p className="text-lg leading-relaxed">
            ...
            digitales que marcan la diferencia. Con un 1 año de experiencia, he
            trabajado en proyectos web, escritorio y móvil.
          </p>
          <p className="text-lg leading-relaxed">
          ...
          <p className="text-lg leading-relaxed">
            Creo firmemente en la colaboración, el aprendizaje continuo y en
            entregar valor real a los clientes a través de soluciones
            tecnológicas bien pensadas.
          </p>
        </div>
